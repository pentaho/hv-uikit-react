...
The fastest way to setup a new **UI Kit** project is by using [`uikit-cli`](./packages/cli). Follow the link for usage documentation. If you're migrating from an older UI Kit version, please follow the [Migration Guides](https://pentaho.github.io/uikit-docs/master/docs/migration).
