...
The UI Kit Flow component allows users to create dynamic and interactive flow diagrams to visualize, for example, business processes, data workflows or user journeys.
...
```tsx
import { HvFlowNode, HvFlowNodeFC } from "@pentaho/uikit-react-lab";
