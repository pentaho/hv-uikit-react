import { avatarClasses as classes, HvAvatar } from "@pentaho/uikit-react-core";
...
<div className="flex gap-xs">
  ...
  <HvAvatar color="violet">VL</HvAvatar>
  <HvAvatar color="yellow">Y</HvAvatar>
</div>
```
...
<div className="flex gap-xs">
  ...
  <HvAvatar size="lg" status="purple" badge="purple">
    AB
  </HvAvatar>
</div>
```
...
<div className="flex items-center gap-xs">
  <HvButtonBase component="a" href="#actions">
    <HvAvatar size="md">
