...
a canvas-based interface. For that reason, they are available in the `@pentaho/uikit-react-pentaho` package.
...
```tsx
import { HvCanvasProvider } from "@pentaho/uikit-react-pentaho";
```
