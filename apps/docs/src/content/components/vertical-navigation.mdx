  ...
  return (
    <div style={{ height: 340 }}>
      <HvVerticalNavigation open={open} useIcons>
        ...
        />
        <HvVerticalNavigationTree
          aria-label="Collapsed menu example"
          selected={selected}
...
const navigationData = [
  { id: "01", label: "Overview", icon: <Open /> },
  {
    id: "02",
    label: "Analytics",
    icon: <BarChart />,
    data: [
      { id: "02-01", label: "Semantic Models" },
      { id: "02-02", label: "Business Reports" },
      { id: "02-03", label: "Dashboards" },
    ],
  },
  {
    id: "03",
    ...
    icon: <Deploy />,
    data: [
      { id: "03-01", label: "Environments" },
      { id: "03-02", label: "Pipelines" },
    ],
  },
  // no `icon`, so the first letter of the label is used instead
  { id: "04", label: "Settings" },
];
```
